								...
								<div class="d-sm-flex justify-content-between">
                                    <div data-aos="zoom-in-up">
                                        <div class="banner-title">
                                            <h3 class="font-weight-medium col-md-4 offset-md-1 col-sm-8">Range Site.</h3>
										</div>
										<p class="mt-3">
                                            Beautiful Websites:
											<br>
										...
										<a href="#" class="btn btn-secondary mt-3">start now</a>
									</div>
					...
					<div class="row" data-aos="fade-up">
						...
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box pb-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src="{{ asset('images/growth-strategy.svg') }}" alt="saving-strategy" data-aos="zoom-in">
				...
				<div class="container">
					<div class="row  mt-md-0 mt-lg-4">
						<div class="col-sm-6 text-white" data-aos="fade-up">
							<h3 class="font-weight-medium">For 1,000Ksh:</h3>
							<ul>
								<li class="">
